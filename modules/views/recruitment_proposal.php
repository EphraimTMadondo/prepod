...
<div class="modal fade" id="recruitment_proposal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content width-125">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('edit_proposal'); ?></span>
                    <span class="add-title"><?php echo _l('new_proposal'); ?></span>
                </h4>
            </div>
