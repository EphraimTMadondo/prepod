                  ...
                  <tr class="project-overview">
                   ...
                   <?php 
                    ...
                    <tr class="project-overview">
                      ...
                      <td><?php echo html_entity_decode($campaign_name); ?></td>
                   </tr>
          ...
          <div class="row">
            ...
            <p><b>Form url:</b>
                <span class="label label-default">
                    <a href="<?php echo site_url('recruitment/forms/wtl/'.$recruitment_channel->form_key); ?>" target="_blank"><?php echo site_url('recruitment/forms/wtl/'.$recruitment_channel->form_key); ?></a>
                </span>
            </p>
            <hr>
            ...
            <textarea class="form-control width-height-738-66" rows="1">&lt;iframe width="600" height="850" src="<?php echo site_url('recruitment/forms/wtl/'.$recruitment_channel->form_key); ?>" frameborder="0" allowfullscreen&gt;&lt;/iframe&gt;</textarea>
