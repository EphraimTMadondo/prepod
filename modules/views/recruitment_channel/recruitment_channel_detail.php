...
<div class="app-content content">
   ...
   <div class="row">
	...
	0 => ['id' => '1', 'name' => _l('form')],
                              ...
                              <?php $rec_campaign_id = (isset($form->rec_campaign_id) ? $form->rec_campaign_id : '');?>
                              <?php echo render_select('rec_campaign_id', $list_rec_campaign, array('cp_id', 'campaign_name'), 'recruitment_campaign', $rec_campaign_id); ?>
