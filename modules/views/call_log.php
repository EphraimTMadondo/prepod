                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group followup-schedule <?php if(!isset($call_log) || $call_log->has_follow_up == 0){echo 'hide';}?>">
                            ...
                            <?php echo render_datetime_input('follow_up_schedule','cl_follow_up_schedule',$value); ?>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php echo render_input('staff_email','cl_call_owner', $owner->email, 'text', ['disabled' => 'disabled']); ?>
