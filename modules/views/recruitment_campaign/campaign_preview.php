...
if (count($campaign_file) > 0) {
	...
	foreach ($campaign_file as $f) {
		...
		$file_html .= '<div class="mbot15 row inline-block full-width" data-attachment-id="' . $f['id'] . '">
		              <div class="col-md-8">
		                 <a name="preview-ase-btn" onclick="preview_campaign_btn(this); return false;"  rel_id = "' . $f['rel_id'] . '" id = "' . $f['id'] . '" href="Javascript:void(0);" class="mb-1 btn btn-success pull-left margin-right-5" data-toggle="tooltip" title data-original-title="' . _l('preview_file') . '"><i class="fa fa-eye"></i></a>
