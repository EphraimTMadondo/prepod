...
?>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo html_entity_decode($candidate->skype); ?></td>
				               </tr>
				               <tr class="project-overview">
                  		...
                  		<table class="table border table-striped margin-top-0">
				            <tbody>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo html_entity_decode($candidate->email); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('facebook'); ?></td>
				                  <td><?php echo html_entity_decode($candidate->facebook); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td>  &nbsp;</td>
				                  <td></td>
...
if (count($candidate->file) > 0) {
	...
	foreach ($candidate->file as $f) {
		...
		$file_html .= '<div class="mbot15 row inline-block full-width" data-attachment-id="' . $f['id'] . '">
					              <div class="col-md-8">
					                 <a name="preview-ase-btn" onclick="preview_candidate_btn(this); return false;" rel_id = "' . $f['rel_id'] . '" id = "' . $f['id'] . '" href="Javascript:void(0);" class="mb-1 btn btn-success pull-left margin-right-5" data-toggle="tooltip" title data-original-title="' . _l('preview_file') . '"><i class="fa fa-eye"></i></a>
