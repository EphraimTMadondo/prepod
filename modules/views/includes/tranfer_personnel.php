...
<div>
<div class="_buttons">
    <a href="#" onclick="new_setting_tranfer(); return false;" class="btn btn-primary">
        <?php echo _l('new'); ?>
    </a>
</div>
