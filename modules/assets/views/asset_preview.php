                	  	...
                	  	<?php
					        ...
					        if(count($asset_file) > 0){
					            ...
					            foreach ($asset_file as $f) {
					              ...
					              <div class="col-md-8">
					                 <a name="preview-ase-btn" onclick="preview_asset_btn(this); return false;" rel_id = "'. $f['rel_id']. '" id = "'.$f['id'].'" href="Javascript:void(0);" class="mb-1 btn btn-success pull-left marginright5" data-toggle="tooltip" title data-original-title="'. _l('preview_file').'"><i class="fa fa-eye"></i></a>
