...
<div>
<div class="_buttons">
    <a href="#" onclick="new_asset_unit(); return false;" class="btn btn-primary">
...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       ...
       <td>
         <a href="#" onclick="edit_asset_unit(this,<?php  echo htmlspecialchars($c['unit_id']); ?>); return false" data-name="<?php  echo htmlspecialchars($c['unit_name']); ?>" class="btn btn-light btn-icon"><i class="bx bx-pencil"></i></a>
          <a href="<?php echo admin_url('assets/delete_asset_unit/'.$c['unit_id']); ?>" class="btn btn-danger btn-icon _delete"><i class="bx bx-trash"></i></a>
       </td>
    </tr>
    <?php } ?>
 </tbody>
