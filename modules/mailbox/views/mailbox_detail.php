                          ...
                          <div class="collapse-title media">
                              <div class="pr-1">
                                  <div class="avatar mr-75">
                                    <?php echo staff_profile_image($inbox->from_staff_id, ['mr-2 rounded-circle',], '', ['width' => '30', 'height' => '30', 'alt' => 'avtar img holder']);?> 
                                  </div>
                              </div>
                              <div class="media-body mt-25">
                                  <span class="text-primary"><?php echo $inbox->sender_name;?></span>
                                  <span class="d-sm-inline d-none"><?php echo $inbox->from_email;?></span>
                                  <small class="text-muted d-block">to <?php echo $inbox->to;?></small>
                              </div>
                          </div>
                          <div class="information d-sm-flex d-none align-items-center">
                              <small class="text-muted mr-50"><?php echo _dt($inbox->date_received)?></small>
                              ...
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="second-open-submenu">
                                      <a href="<?php echo admin_url().'mailbox/reply/'.$inbox->id.'/reply';?>" class="dropdown-item mail-reply">
                                          <i class='bx bx-share'></i>
                                          <?php echo _l('mailbox_reply'); ?>
                                      </a>
                                      <a href="<?php echo admin_url().'mailbox/reply/'.$inbox->id.'/forward';?>" class="dropdown-item">
