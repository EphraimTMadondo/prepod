                  ...
                  $total_invoices_awaiting_payment = total_rows(db_prefix().'invoices',"company_username ='$companyusername'",'status NOT IN (2,5,6)'.(!has_permission('invoices','','view') ? ' AND ' . get_invoices_where_sql_for_staff(get_staff_user_id()) : ''));
                      ...
                      ?>
                       ...
                       <div class="badge-circle badge-circle-lg badge-circle-light-warning mx-auto mb-50">
                                   <i class="hidden-sm fa fa-balance-scale font-medium-5"></i>
                       </div>
                       </p>
                       <p class="center">
                       <?php echo _l('invoices_awaiting_payment'); ?><br/>
                     ...
                     $total_leads_converted = total_rows(db_prefix().'leads',"company_username ='$companyusername'",$where);
                      ...
                      ?>
                       ...
                       <div class="badge-circle badge-circle-lg badge-circle-light-success mx-auto mb-50">
                                   <i class="hidden-sm fa fa-tty font-medium-5"></i>
                       </div>
                       </p>
                       <p class="center"></i> <?php echo _l('leads_converted_to_client'); ?><br/>
                     ...
                     $total_projects = total_rows(db_prefix().'projects',"company_username ='$companyusername'",$_where);
                      ...
                      <p class="text-uppercase mtop5">
                       <div class="badge-circle badge-circle-lg badge-circle-light-primary mx-auto mb-50">
                                   <i class="hidden-sm fa fa-cubes font-medium-5"></i>
                       </div>
                       </p>
                       <p class="center"></i> <?php echo _l('projects') . ' ' . $project_status['name']; ?><br/><span class="pull-right"><?php echo $total_projects_in_progress; ?> / <?php echo $total_projects; ?></span></p>
                       <div class="clearfix"></div>
                       <div class="progress no-margin progress-bar-mini">
            ...
            <div class="card text-center">
                <div class="card-content">
                   ...
                   <div class="badge-circle badge-circle-lg badge-circle-light-danger mx-auto mb-50">
                               <i class="hidden-sm fa fa-tasks font-medium-5"></i>
                   </div>
                   </p>
                   <p class="center"></i> <?php echo _l('tasks_not_finished'); ?> <br/><span class="pull-right">
