...
<div class="btn-group float-right mleft4 mbot25 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
   ...
   <ul class="dropdown-menu width300">
    ...
    <li class="dropdown-item clear-all-prevent<?php if($status['filter_default'] == true){echo ' active';} ?>">
    ...
    <?php } ?>
    <li class="dropdown-divider"></li>
    <li class="dropdown-item filter-group" data-filter-group="group-date">
    ...
    <li class="dropdown-divider"></li>
    <li class="dropdown-item filter-group <?php echo (!has_permission('tasks','','view') ? ' active' : ''); ?>" data-filter-group="assigned-follower-not-assigned">
    ...
    <li class="dropdown-item filter-group" data-filter-group="assigned-follower-not-assigned">
    ...
    <li class="dropdown-divider"></li>
    <li class="dropdown-item filter-group" data-filter-group="group-billable">
