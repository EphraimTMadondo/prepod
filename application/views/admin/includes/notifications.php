...
<ul style = "right: 0;
    left: auto;padding: 0px 0;padding: 8px 12px 6px;" class="dropdown-menu notifications animated fadeIn width400" data-total-unread="<?php echo $current_user->total_unread_notifications; ?>">
