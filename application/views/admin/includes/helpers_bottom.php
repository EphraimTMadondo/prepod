...
<!-- Task modal view -->
<div class="modal modal-dialog-centered modal-full modal-dialog-scrollable task-modal-single" id="task-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
