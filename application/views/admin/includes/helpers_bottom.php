...
<!-- Task modal view -->
<div class="modal fade task-modal-single modal-dialog-centered modal-full modal-dialog-scrollable" id="task-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
