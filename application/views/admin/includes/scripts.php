...
-->
<script type="text/javascript" id="jquery-validation-js" src="<?php echo base_url();?>application/views/themes/assets/plugins/query-validation/jquery.validate.js"></script>
