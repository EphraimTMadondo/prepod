                  ...
                  <div class="row">
                     <div class="col-md-5ths">
                        <div class="select-placeholder">
                           <select name="range" id="range" class="selectpicker" data-style="btn-primary" data-width="100%">
                        ...
                        <div class="row mt-1">
                           ...
                           <div class="col-md-5ths ml-1">
                              <div class="select-placeholder">
                                 <select name="staff_id" id="staff_id" class="selectpicker" data-style="btn-primary" data-width="100%">
                           ...
                           <div class="col-md-5ths ml-1">
                              <div class="select-placeholder">
                                 <select id="clientid" name="clientid" data-live-search="true"  data-style="btn-primary" data-width="100%" class="ajax-search" data-empty-title="<?php echo _l('client'); ?>" data-none-selected-text="<?php echo _l('client'); ?>">
                                 </select>
                              </div>
                           </div>
                           <div class="col-md-5ths ml-1">
