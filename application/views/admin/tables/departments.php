...
$companyusername = $_SESSION['current_company'];
 array_push($where, 'AND ('.db_prefix()."departments.company_username = '$companyusername')");

$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, [], $where, ['email', 'hidefromclient', 'host', 'encryption', 'password', 'delete_after_import', 'imap_username']);
