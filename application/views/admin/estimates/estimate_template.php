      ...
      <div class="col-md-12 mt-1">
         <div class="card-body bottom-transaction">
            ...
            <div class="btn-bottom-toolbar text-right">
              <button type="button" class="btn-tr btn btn-secondary ml-1 estimate-form-submit save-and-send transaction-submit">
              <?php echo _l('save_and_send'); ?>
              </button>
              <button type="button" class="btn-tr btn btn-secondary ml-1 estimate-form-submit transaction-submit">
              <?php echo _l('submit'); ?>
              </button>
            </div>
         </div>
