    ...
    <table class="table table-hover no-mtop">
        ...
        <tbody>
            ...
            <tr class="payment">
                ...
                <td>
                    <a href="<?php echo admin_url('payments/payment/'.$payment['paymentid']); ?>" class="btn btn-light btn-icon"><i class="bx bx-pencil"></i></a>
                    <?php if(has_permission('payments','','delete')){ ?>
                    <a href="<?php echo admin_url('invoices/delete_payment/'.$payment['paymentid'] . '/' . $payment['invoiceid']); ?>" class="btn btn-danger btn-icon _delete"><i class="bx bx-trash"></i></a>
                    <?php } ?>
                </td>
            </tr>
            <?php } ?>
