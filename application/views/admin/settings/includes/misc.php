...
<ul class="nav nav-tabs" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link active" href="#misc" aria-controls="misc" role="tab" data-toggle="tab">
      <i class="fa fa-cog"></i> <?php echo _l('settings_group_misc'); ?></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" href="#settings_tables" aria-controls="settings_tables" role="tab" data-toggle="tab">
      <i class="fa fa-table"></i> <?php echo _l('tables'); ?></a>
    </li>
    <li class="nav-item" role="presentation">
      <a class="nav-link" href="#inline_create" aria-controls="inline_create" role="tab" data-toggle="tab">
