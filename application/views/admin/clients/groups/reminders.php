...
<?php if(isset($client)){ ?>
<a href="#" data-toggle="modal" data-target=".reminder-modal-customer-<?php echo $client->userid; ?>" class="btn btn-secondary mbot25"><i class="fa fa-bell-o"></i> <?php echo _l('set_reminder'); ?></a>
