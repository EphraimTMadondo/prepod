...
<?php if(isset($client)){ ?>
	...
	<?php if(has_permission('invoices','','create')){ ?>
		<a href="<?php echo admin_url('invoices/invoice?customer_id='.$client->userid); ?>" class="btn btn-secondary mbot15<?php if($client->active == 0){echo ' disabled';} ?>">
	...
	<?php if(has_permission('invoices','','view') || has_permission('invoices','','view_own') || get_option('allow_staff_view_invoices_assigned') == '1'){ ?>
		<a href="#" class="btn btn-secondary mbot15" data-toggle="modal" data-target="#client_zip_invoices">
