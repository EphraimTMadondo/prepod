...
.bootstrap-select .btn-default {
    ...
    padding-left: 10px;
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" style = "color:white !important;" id="myModalLabel"><?php echo $title; ?><br /><small class="color-white" id=""><?php echo get_company_name($customer_id,true); ?></small></h4>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-secondary" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" data-form="#contact-form"><?php echo _l('submit'); ?></button>
    </div>
    <?php echo form_close(); ?>
</div>
</div>
