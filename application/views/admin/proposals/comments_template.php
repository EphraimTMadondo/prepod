...
<div class="col-md-12" data-commentid="<?php echo $comment['id']; ?>">
   ...
   <div class="media-body">
      ...
      <div data-proposal-comment-edit-textarea="<?php echo $comment['id']; ?>" class="hide mt-1">
         ...
         <div class="text-right">
            ...
            <button type="button" class="btn btn-secondary" onclick="edit_proposal_comment(<?php echo $comment['id']; ?>);"><?php echo _l('update_comment'); ?></button>
         </div>
         <?php } ?>
      </div>
   </div>
