  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="#" class="btn btn-secondary" onclick="project_files_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
          ...
          <td>
            <?php if($file['staffid'] != 0){
             ...
             echo ' <img src="'.contact_profile_image_url($file['contact_id'],'thumb').'" class="img avatar avata-sm mrigh5">
