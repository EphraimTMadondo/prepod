...
<div class="row">
   ...
   <div class="col-md-12 text-center mt-2">
      <button type="submit" class="btn btn-secondary" data-form="#open-new-ticket-form" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('submit'); ?></button>
   </div>
</div>
<?php echo form_close(); ?>
