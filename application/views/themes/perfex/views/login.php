          ...
          <h1 class="login-title">LOG IN</h1>
            ...
            <div class="g-recaptcha mbot15" data-sitekey="<?php echo get_option('recaptcha_site_key'); ?>"></div>
                ...
                <div class="form-group"  style = "margin-bottom: 20px;">
                   <button type="submit" class="btn btn-secondary btn-block pb-button--primary" style ="border-radius: 2px; background-color:green;"><?php echo _l('clients_login_login_string'); ?></button>
