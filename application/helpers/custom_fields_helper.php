    ...
    if (count($fields)) {
        ...
        foreach ($fields as $field) {
            ...
            if ($is_admin
                ...
                $fields_html .= '<a href="' . admin_url('custom_fields/field/' . $field['id']) . '" tabindex="-1" target="_blank" class="custom-field-inline-edit-link"><i class="bx bx-pencil"></i></a>';
            }
