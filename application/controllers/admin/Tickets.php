...
class Tickets extends AdminController
{
    ...
    public function predefined_replies()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            array_push($where, 'AND ('.db_prefix()."tickets_predefined_replies.company_username = '$companyusername')");
    ...
    public function services()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $where =[];
            $companyusername = $_SESSION['current_company'];
            array_push($where, 'AND ('.db_prefix()."services.company_username = '$companyusername')");
