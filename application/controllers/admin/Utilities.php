...
//zxxx
    ...
    public function migrate_data(){
        $this->utilities_model->migrate_data();
        echo 1;
    }
    
    public function migrate_data_v2(){
        $this->utilities_model->migrate_data_v2();
        //echo 1;
    }
    
    public function get_migrated_new_option($option,$company_username=""){
        $data = $this->utilities_model->get_new_option($option,$company_username);
        //echo $_SESSION['current_company'];
        echo json_encode($data);
    }
    
    public function get_migrated_new_options($company_username){
