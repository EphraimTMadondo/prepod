...
class Reports extends AdminController
{
    ...
    public function customers_report()
    {
        if ($this->input->is_ajax_request()) {
            ...
            array_push($where, 'AND ('.db_prefix()."clients.company_username = '$companyusername')");
    ...
    public function proposals_report()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $companyusername = $_SESSION['current_company'];
             array_push($where, 'AND ('.db_prefix()."proposals.company_username = '$companyusername')");
    ...
    public function estimates_report()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $companyusername = $_SESSION['current_company'];
 array_push($where, 'AND ('.db_prefix()."estimates.company_username = '$companyusername')");
    ...
    public function credit_notes()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $where = [];
            $companyusername = $_SESSION['current_company'];
            array_push($where, 'AND ('.db_prefix()."creditnotes.company_username = '$companyusername')");
    ...
    public function invoices_report()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $companyusername = $_SESSION['current_company'];
            array_push($where, 'AND ('.db_prefix()."invoices.company_username = '$companyusername')");
            $join         = [
                'LEFT JOIN ' . db_prefix() . 'clients ON ' . db_prefix() . 'clients.userid = ' . db_prefix() . 'invoices.clientid',
            ];
    ...
    public function expenses($type = 'simple_report')
    {
        ...
        if ($type != 'simple_report') {
            ...
            if ($this->input->is_ajax_request()) {
                ...
                $where  = [];
                $companyusername = $_SESSION['current_company'];
                array_push($where, 'AND ('.db_prefix()."expenses.company_username = '$companyusername')");
                $filter = [];
