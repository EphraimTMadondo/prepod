...
*
*/
define('APP_BASE_URL', 'https://worksuite.app/preprod/');
...
*/
define('APP_ENC_KEY', '244cc6ac340cb768939282ca03d96437');
 ...
 */
define('APP_DB_USERNAME', 'worksuit_os_user');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'CVvpRoP;(X5R');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'worksuit_os');
