...
function _table_jump_to_page(e, t) {
    ...
    if ((n.length && n.remove(), a.pages > 1)) {
        for (var i = $("<select></select>", { "data-id": t.sTableId, class: "dt-page-jump-select form-control", id: "dt-page-jump-" + t.sTableId }), o = "", r = 1; r <= a.pages; r++)
...
function alert_float(e, t, a) {
    ...
    (n = $("body").find("float-alert").length),
        (n = "alert_float_" + ++n),
        (i = $("<div></div>", { id: n, class: "float-alert animated fadeInRight col-xs-10 col-sm-3 alert alert-" + e })).append(
...
function get_url_param(e) {
    var t = {};
    return (
        window.location.href.replace(location.hash, "").replace(/[?&]+([^=&]+)=?([^&]*)?/gi, function (e, a, n) {
            t[a] = void 0 !== n ? n : "";
        }),
        e ? (t[e] ? t[e] : null) : t
    );
    ...
    if (0 !== n.length) {
        var i = {
                ...
                initComplete: function (e, t) {
                    (this.hasClass("scroll-responsive") || 1 == o.scrollResponsive) && this.wrap('<div class="table-responsive"></div>');
                    var a = this.find(".dataTables_empty");
                    if ((a.length && a.attr("colspan", this.find("thead th").length), o.supportsLoading && this.parents(".table-loading").removeClass("table-loading"), o.supportsButtons)) {
                        (i = n.find("thead th:last-child")).hasClass("options") && i.addClass("not-export");
                        var i = n.find("thead th:last-child");
                        "undefined" != typeof app && i.text().trim() == app.lang.options && i.addClass("not-export");
                        var r = n.find("thead th:first-child");
                        r.find('input[type="checkbox"]').length > 0 && r.addClass("not-export"), "function" == typeof o.onInitComplete && o.onInitComplete(e, t, this);
                    }
                },
            },
            o = $.extend({}, i, t),
        ...
        (o.pageLength = parseFloat(o.pageLength)),
            -1 == $.inArray(o.pageLength, r) && (r.push(o.pageLength), s.push(o.pageLength)),
            r.sort(function (e, t) {
                return e - t;
            }),
            s.sort(function (e, t) {
        ...
        (o.lengthMenu = [r, s]),
            ...
            $.each(n, function () {
                if (
                    ...
                    ($(this).hasClass("scroll-responsive") || 1 == o.scrollResponsive) && (o.responsive = !1),
                    ...
                    for (var a = 0; a < t; a++) {
                        ...
                        o.aoColumns.push(i ? { sType: i.type } : null);
                    }
                }
                o.supportsButtons && (o.buttons = get_datatable_buttons(this)), $(this).DataTable(o);
            });
    }
}
function get_datatable_buttons(e) {
    ...
    var n = {
            body: function (e, t, a, n) {
                var i = $("<div></div>", e);
                i.append(e), i.find("[data-note-edit-textarea]").length > 0 && (i.find("[data-note-edit-textarea]").remove(), (e = i.html().trim()));
                var o = i.find(".text-has-action.is-date");
                o.length && (e = o.attr("data-title")),
                    i.find(".row-options").length > 0 && (i.find(".row-options").remove(), (e = i.html().trim())),
                    i.find(".table-export-exclude").length > 0 && (i.find(".table-export-exclude").remove(), (e = i.html().trim()));
...
function _dt_maybe_export_only_selected_rows(e, t) {
    ...
    if (a && a.length > 0) {
        ...
        return (
            ...
            i ? (t.find("tbody tr:eq(" + e + ') td:first input[type="checkbox"]:checked').length > 0 ? e : null) : e
        );
    }
    return e;
}
...
function appDatepicker(e) {
    ...
    var t = { date_format: app.options.date_format, time_format: app.options.time_format, week_start: app.options.calendar_first_day, date_picker_selector: ".datepicker", date_time_picker_selector: ".datetimepicker" },
        ...
        i = void 0 !== a.element_time ? a.element_time : $(a.date_time_picker_selector);
    (0 === i.length && 0 === n.length) ||
        ($.each(n, function () {
            var e = $(this),
                t = { timepicker: !1, scrollInput: !1, lazyInit: !0, format: a.date_format, dayOfWeekStart: a.week_start },
        ...
        $.each(i, function () {
            var e = $(this),
                t = { lazyInit: !0, scrollInput: !1, validateOnBlur: !1, dayOfWeekStart: a.week_start };
            24 == a.time_format ? (t.format = a.date_format + " H:i") : ((t.format = a.date_format + " g:i A"), (t.formatTime = "g:i A"));
...
function _dropzone_defaults() {
    ...
    return (
        "safari" === app.browser && e.indexOf(".jpg") > -1 && -1 === e.indexOf(".jpeg") && (e += ",.jpeg"),
        {
...
!(function (e) {
    ...
    e.fn.appFormValidator = function (a) {
        var n = this,
            i = { email: { remote: e.fn.appFormValidator.internal_options.localization.email_exists } },
            o = {
                rules: [],
                messages: [],
                ignore: [],
                ...
                submitHandler: function (t) {
                    var a = e(t);
                    a.hasClass("disable-on-submit") && a.find('[type="submit"]').prop("disabled", !0);
        ...
        return (
            ...
            (n.configureJqueryValidationDefaults = function () {
                ...
                (t = !0),
                    e.validator.setDefaults({
                        ...
                        unhighlight: e.fn.appFormValidator.internal_options.error_unhighlight,
                        ...
                        errorPlacement: e.fn.appFormValidator.internal_options.error_placement,
                    }),
                    n.addMethodFileSize(),
            ...
            (n.addMethodFileSize = function () {
                e.validator.addMethod(
                    ...
                    e.fn.appFormValidator.internal_options.localization.file_exceeds_max_filesize
                );
            }),
            (n.addMethodExtension = function () {
                e.validator.addMethod(
                    ...
                    e.fn.appFormValidator.internal_options.localization.validation_extension_not_allowed
                );
            }),
            (n.validateCustomFields = function (t) {
                e.each(t.find(e.fn.appFormValidator.internal_options.required_custom_fields_selector), function () {
                    if (!e(this).parents("tr.main").length && (e(this).rules("add", { required: !0 }), e.fn.appFormValidator.internal_options.on_required_add_symbol)) {
                        var t = e(this)
                            .parents("." + e.fn.appFormValidator.internal_options.field_wrapper_class)
            ...
            (n.addRequiredFieldSymbol = function (t) {
                e.fn.appFormValidator.internal_options.on_required_add_symbol &&
                    e.each(r.rules, function (e, a) {
                        if (("required" == a && !jQuery.isPlainObject(a)) || (jQuery.isPlainObject(a) && a.hasOwnProperty("required"))) {
                            var n = t.find('[for="' + e + '"]');
                            n.length > 0 && 0 === n.find(".req").length && n.prepend(' <small class="req text-danger">* </small>');
                        }
                    });
            }),
            ...
            n.each(function () {
                var t = e(this);
                t.data("validator") && t.data("validator").destroy(), t.validate(r), n.validateCustomFields(t), n.addRequiredFieldSymbol(t), e(document).trigger("app.form-validate", t);
            })
        );
    };
})(jQuery),
    ...
    (function (e) {
        e.fn.googleDrivePicker = function (t) {
            var a,
                ...
                i = {
                    ...
                    onAuthApiLoad: function (e) {
                        (e.disabled = !1),
                            e.addEventListener("click", function () {
                                gapi.auth2.authorize({ client_id: o.clientId, scope: o.scope }, i.handleAuthResult);
                            });
                    },
                    ...
                    createPicker: function () {
                        if (n && a) {
                            var t = new google.picker.DocsView().setParent("root").setIncludeFolders(!0),
                                r = new google.picker.DocsUploadView().setIncludeFolders(!0);
                            o.mimeTypes && (t.setMimeTypes(o.mimeTypes), r.setMimeTypes(o.mimeTypes)),
                                new google.picker.PickerBuilder().addView(t).addView(r).setOAuthToken(a).setDeveloperKey(o.developerKey).setCallback(i.pickerCallback).build().setVisible(!0),
                                setTimeout(function () {
                    ...
                    pickerCallback: function (e) {
                        if (e[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
                            var t = e[google.picker.Response.DOCUMENTS][0],
                                a = [{ name: t[google.picker.Document.NAME], link: t[google.picker.Document.URL], mime: t[google.picker.Document.MIME_TYPE] }];
            ...
            return this.each(function () {
                o.clientId ? (e(this).data("on-pick") && (o.onPick = e(this).data("on-pick")), i.initGooglePickerAPI(e(this)[0]), e(this).css("opacity", 1)) : e(this).css("opacity", 0);
            });
        };
    })(jQuery),
    ...
    $(function () {
        ...
        $("body").on("click", ".add_more_attachments", function () {
            ...
            var a = $(".attachments").find(".attachment").eq(0).clone().appendTo(".attachments");
            a.find("input").removeAttr("aria-describedby aria-invalid"),
                a
                    .find("input")
                    .attr("name", "attachments[" + e + "]")
                    .val(""),
                a.find($.fn.appFormValidator.internal_options.error_element + '[id*="error"]').remove(),
                a.find("." + $.fn.appFormValidator.internal_options.field_wrapper_class).removeClass($.fn.appFormValidator.internal_options.field_wrapper_error_class),
                a.find("i").removeClass("fa-plus").addClass("fa-minus"),
                a.find("button").removeClass("add_more_attachments").addClass("remove_attachment").removeClass("btn-success").addClass("btn-danger"),
                e++;
        }),
